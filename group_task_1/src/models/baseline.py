...
class BaselineCRNN(BaseASRModel):
    """Lightweight CRNN for ASR. Designed to be < 5M parameters."""
    ...
    def __init__(
        ...
        # Convolutional front-end: 2x downsample via stride-2 conv
    ...
    def forward(
        ...
        Returns:
            ...
            output_lengths: Tensor of shape [batch] with downsampled lengths
        """
        ...
        # Pack to skip computation over padding
...
if __name__ == "__main__":
    model = BaselineCRNN()
    print(f"Model parameters: {model.get_num_params() / 1e6:.2f} M")  # noqa: T201
